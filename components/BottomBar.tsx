...
export const BottomBar: React.FC<BottomBarProps> = ({ activeTab, onTabChange, onExport, onClearContent }) => {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white px-4 py-2 pb-safe z-50 flex items-center justify-between shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
      {/* Tab Switcher */}
